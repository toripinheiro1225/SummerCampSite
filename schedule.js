...
(function () {
  ...
  const events = [
    ...
    { day: "thu", start: 15, end: 15.5, title: "Baby Music Time", loc: "Baby Dome", time: "3:00 - 3:30", type: "default" },
    ...
    // Friday
    { day: "fri", start: 8, end: 9.5, title: "Bird-watching ('Nocs Provided!)", loc: "Fireside", time: "8:00 - 9:30", type: "default" },
    ...
    // Saturday
    { day: "sat", start: 10.5, end: 11.5, title: "Tai Chi Chai Tea", loc: "Open Area Near Dome", time: "10:30 - 11:30", type: "default" },
    ...
    { day: "sat", start: 15, end: 16, title: "Baby Painting", loc: "Shade Tree near River Deck", time: "3:00 - 4:00", type: "default" },
    { day: "sat", start: 16, end: 16.5, title: "Baby Chorus", loc: "Shade Tree near River Deck", time: "4:00 - 4:30", type: "default" },
    ...
    // Sunday
    { day: "sun", start: 11, end: 12, title: "Bad Church", loc: "Fire Pit", time: "11:00 - 12:00", type: "default" },
